...
-- Copiando dados para a tabela app_simulado.opcoes: 812 rows
...
-- Copiando dados para a tabela app_simulado.pontuacoes_por_tipo: 8 rows
...
-- Copiando dados para a tabela app_simulado.questoes: 203 rows
...
-- Copiando dados para a tabela app_simulado.respostas_usuario: 68 rows
...
-- Copiando dados para a tabela app_simulado.usuarios: 2 rows
...
INSERT INTO "usuarios" ("id", "nome", "email", "senha", "tipo_acesso", "data_criacao") VALUES
	...
	(2, 'luiza', 'luiza@test.com', '$2a$10$ORiPDknJp.dpiGEBH11S2OmHLGGba3qDTl.4elwDi8QLVPt1XdmKK', 'admin', '2025-08-27 14:29:16.152749');
